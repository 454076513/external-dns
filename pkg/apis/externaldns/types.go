...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("publish-node-external-ip", "Allow external-dns to publish external-ip on node for headless services. If no external-ip , Get host-ip (optional)").BoolVar(&cfg.PublishNodeExternalIP)
